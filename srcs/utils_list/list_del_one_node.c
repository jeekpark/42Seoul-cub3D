...
/*   Updated: 2023/10/30 23:42:51 by jeekpark         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../../includes/cub3d.h"

static void	_del_node(t_node *node, void (*del)(void *))
{
	t_node	*node1;
	t_node	*node2;
...
static void	_del_head(t_list *list, t_node *node, void (*del)(void *))
{
	t_node	*node_temp;
...
static void	_del_tail(t_list *list, t_node *node, void (*del)(void *))
{
	t_node	*node_temp;
...
static void	_del_cursor(t_list *list, t_node *node, void (*del)(void *))
{
	_del_node(node, del);
	list->cursor = list->head;
}
